...
private class ParseTask extends AsyncTask<Void,Void,String>{
    ...
    final String[] abitur = {"Малькова Валерия Михайловна","Сафонова Елена Александровна","Королёва Мария Владимировна","Горшкова Инна Романовна","Кулешова Мария Александровна","Новикова Татьяна Анатольевна","Черагина Ирина Александровна","Козлов Владимир Сергеевич","Садовая Валерия Олеговна","Новикова Екатерина Александровна","Казакова Татьяна Вячеславовна","Панкратова Валерия Павловна","Попова Ольга Александровна","Ларина Ольга Денисовна","Скачкова Наталья Алексеевна","Беспалова Екатерина Николаевна"}; //куда-то сюда прихуярить жсон с массивом школоло
